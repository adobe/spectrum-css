  ...
  render() {
    ...
    return (
      <div>
        <div>
          <div
            className={classNames("afg-container-fluid", styles.mainContainer)}
          >
            <header class="spectrum-CSSComponent-heading" id="accordion">
              <h2 class="spectrum-CSSComponent-title spectrum-Article spectrum-Heading1--display">
                <a class="spectrum-BigSubtleLink" href="#">
            ...
            <table class="spectrum-CSSComponent-detailsTable">
              <tbody>
                <tr>
                  ...
                  <td>
                    <div class="spectrum-StatusLight spectrum-CSSComponent-status spectrum-StatusLight--notice">
                      Contribution
                    </div>
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td>@spectrum-css/accordion@2.0.0-alpha.6</td>
                </tr>
              </tbody>
            </table>

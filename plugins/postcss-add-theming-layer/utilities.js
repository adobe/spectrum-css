...
function getVariableName(
	...
	return `--${[
		...
		baseSelector,
		selectorDetails,
		// Inject a random numerical string at least 4 long to ensure the variable name is unique and does not get used in downstream code for customizations
		parseInt(Math.random() * 10000, 10).toString().padStart(4, "0"),

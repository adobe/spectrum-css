...
import { Template as IllustratedMessageTemplate } from '../../illustratedmessage/stories/template.js';
import { Template as LinkTemplate } from '../../link/stories/template.js';
...
export const Template = ({ rootClass, size = 'm', customClasses = [] }) => {
  ...
  return html`
    <div class=${classMap(classList)} role="region" tabindex="0" style="width: 300px;">
      ${IllustratedMessageTemplate({
        variant: 'cta',
        ...
        description: html`${LinkTemplate({ content: 'Select a file' })} from your computer.`,
      })}
    </div>
  `;
}

...
/* Create a table cell */
export const createCells = (cells, visualElements = {}) => {
...
export const createRow = (rowProps = {}, cellsData = [], options = {}) => {
	const { visualElements = {}, sortableColumns = [], sortableIconNames = {} } = options;
	...
	return {
		...rowProps,
		rowContent: createCells(cellsData, visualElements),
	};
};

...
/**
 * The default table also uses the regular density.
 */
...
Visuals.args = {
	rowItems: [
		...
		createRow(
			{},
			["Avatar Example", "Column 2", "Column 3"],
			{
				visualElements: {
					0: "avatar", 1: "icon", 2: "thumbnail"
				}}
		),
		createRow(
			{},
			["Icon Example", "Column 2", "Column 3"],
			{
				visualElements: {
					0: "icon",
					1: "avatar",
		...
		createRow(
			{},
			["Thumbnail Example", "Column 2", "Column 3"],
			{
				visualElements: {
					0: "thumbnail",
					1: "avatar",

 ...
 *
 * When marking a field as required, a non-breaking space (e.g. U+00A0 or &nbsp;) should be placed between the label text and the required marker to prevent the marker from appearing on its own line.
 */

...
export const Template = ({
	...
	>
		...
		content: [
			() => html`
				${when(hasImage, () => html`<div class="${rootClass}-image-wrapper">
				...
				<div class="${rootClass}-footer">
					...
					${ButtonGroup({
						customClasses: window.scale === "large" ? [`${rootClass}-buttongroup--mobile`] : [`${rootClass}-buttongroup`],
						size: window.scale === "large" ? "s" : "m",
						items: window.scale === "large" ?
							[
								{
									variant: "secondary",
									treatment: "outline",

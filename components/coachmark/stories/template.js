...
import "@spectrum-css/coachmark/index.css";
		...
		>
			${Popover({
				...
				content: [
					html`
						${hasImage
							? html`<div class="${rootClass}-image-wrapper">
									<img
						...
						<div class="spectrum-CoachMark-content">
							...
							other design and drawing tools. Start drawing, and zoom in to see
							the pixels in each stroke.
						</div>

...
-     **thumbnail:**remove typo from docs([30b2ea1](https://github.com/adobe/spectrum-css/commit/30b2ea1))
  ...
  🗓 20\*refactor(thumbnail)!: remove focus-ring pseudo class([d783ada](https://github.com/adobe/spectrum-css/commit/d783ada))
...
🗓 20chore(opacitycheckerboard): generate new component
...
- chore(opacitycheckerboard): removes thumbnail border fix
  🗓 20chore(opacitycheckerboard): address PR feedback

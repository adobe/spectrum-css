...
import "@spectrum-css/popover/index-base.css";
            ...
            trigger({
                ...
                onclick: () => {
                    setTimeout(() => {
                        ...
                        if (x)
                            transforms.push(
                                `translateX(calc(var(--flow-direction) * calc(${parseInt(x, 10)}px ${xOffset})))`,
                            );
                        ...
                        if (position === "top-start" || position === "bottom-start") {
                            additionalStyles["inset-inline-start"] =
                                "calc(" + popWidth / 2 + "px - var(--spectrum-popover-pointer-edge-offset))";
                        } else if (position === "top-end" || position === "bottom-end") {
                            additionalStyles["inset-inline-start"] =
                                "calc(-1 *" + popWidth / 2 + "px + var(--spectrum-popover-pointer-edge-offset))";
                        } else if (position === "left-top" || position === "right-top") {
                            additionalStyles["inset-block-start"] =
                                "calc(" + popHeight / 2 + "px - var(--spectrum-popover-pointer-edge-offset))";
                        } else if (position === "left-bottom" || position === "right-bottom") {
                            additionalStyles["inset-block-start"] =
                                "calc(-1 *" + popHeight / 2 + "px + var(--spectrum-popover-pointer-edge-offset))";
                        }

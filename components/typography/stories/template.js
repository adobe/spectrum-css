...
export const Template = ({
  ...
  const classes = {
    [rootClass]: true,
    [`${rootClass}--${glyph}`]: typeof semantics !== "undefined" && typeof glyph !== "undefined" && glyph !== "sans-serif",
  ...
  if (variant && Array.isArray(variant)) {
    if (["strong", "emphasized"].every(i => variant.includes(i))) {
      content = html`<span class=${classMap({

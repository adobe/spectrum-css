  ...
  return svg`
    ...
    style=${styleMap({
      ...
      ...customStyles
        ...
        <defs>
          ${express ?
            svg`<path id="express-inner-loupe" class="${rootClass}-inner" d="M-14330.692,18055.742A15.922,15.922,0,0,1-14334,18046a16,16,0,0,1,16-16,16,16,0,0,1,16,16,15.925,15.925,0,0,1-3.166,9.555c-.009.016-.018.029-.028.045-2.577,4.033-12.77,14.4-12.77,14.4S-14328.027,18059.484-14330.692,18055.742Z" />` :
            svg`<path id="spectrum-inner-loupe" class="${rootClass}-inner" d="M24,0A24,24,0,0,1,48,24c0,16.255-24,40-24,40S0,40.255,0,24A24,24,0,0,1,24,0Z" />`
          }
          ...
          ${express ?
            svg`<clipPath id="express-loupe-clip">
              <use xlink:href="#express-inner-loupe" href="#express-inner-loupe"/>
            </clipPath>
            <clipPath id="express-checkerboard-loupe-clip">
              <use xlink:href="#express-inner-loupe" href="#express-inner-loupe" transform="translate(14688 -17741)" />
            </clipPath>`:
            svg`<clipPath id="spectrum-loupe-clip">
              <use xlink:href="#spectrum-inner-loupe" href="#spectrum-inner-loupe"/>
            </clipPath>`
          }

...
- [#2352](https://github.com/adobe/spectrum-css/pull/2352) [`46ae687`](https://github.com/adobe/spectrum-css/commit/46ae6870881d9d917568009fb4e0fcf647eb45a7) Thanks [@pfulton](https://github.com/pfulton)! - Fixes to align `spectrum-two` with `s2-foundations-redux`/`main`, mostly defining unused custom properties, but addresses any other lint warnings or inconsistencies noted in the following components:

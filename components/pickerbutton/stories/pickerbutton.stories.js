...
/**
 * These examples use custom icons. The icon on the left is a custom UI icon, and the icon on the right is a custom workflow icon. The size of the icon can also be modified by using the `--spectrum-icon-size` custom property. Here, `--spectrum-icon-size` is set to `14px`.
 *

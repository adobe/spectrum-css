  ...
  platforms: {
    CSS: {
      ...
      files: [
        ...
        ...setNames.map(context => generateFileConfig({ setName: context, subSystemName: 'spectrum' })),
        ...setNames.map(context => generateFileConfig({ setName: context, subSystemName: 'express' })),
      ],
    },
  },
};

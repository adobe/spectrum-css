...
- `id`: allows users to pass in a custom ID value and should be added to the top-level wrapper of the component. By default, all components set the id using the `getRandomId` function from the `../decorators` package.

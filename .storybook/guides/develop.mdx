...
- `stories/*.stories.js` and `stories/template.js` - The storybook assets for rendering components in Storybook and used in visual regression testing.
...
- `themes/spectrum.css`: Represents the current Spectrum theme, aka Spectrum 2.
- `themes/legacy.css`: Represents the legacy Spectrum theme, aka Spectrum 1. **deprecated**

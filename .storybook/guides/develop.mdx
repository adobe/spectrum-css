...
- `customStorybookStyles` (object): used to pass custom inline CSS to be assigned to the root container of the story. Only works when the `withPreviewStyles` decorator is applied.
...
export const Template = ({
 ...
 customStyles = {},
  ...
  >
   ...
   ${when(iconName, () => Icon({ iconName, scale, customClasses: [`${rootClass}s-itemIcon`] }))}

...
The checkbox component is an example of an element that has a width of 24px or less by default.
...
The button component is an example of an element that usually has a width greater than 24px by default.

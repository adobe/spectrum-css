...
function getProcessors(keepVars = false, notNested = true, secondNotNested = true, diff = false) {
 // console.log('i am here');
  return [
    ...
    diff ? require('../tools/component-builder/css/plugins/postcss-varsonly')() : null,
    require('postcss-logical')(),
    require('../tools/component-builder/css/plugins/postcss-transform-logical')(),
    require('postcss-dir-pseudo-class')(),
    require('../tools/component-builder/css/plugins/postcss-custom-properties-passthrough')(),
    require('postcss-calc'),
    keepVars ? require('../tools/component-builder/css/plugins/postcss-custom-properties-mapping') : null,
    notNested ? require('../tools/component-builder/css/plugins/postcss-notnested')({ replace: '.spectrum' }) : null,
    require('postcss-svg'),
    ...
    require('../tools/component-builder/css/plugins/postcss-strip-comments')({ preserveTopdoc: false }),
    require('postcss-dropunusedvars'),
    require('postcss-dropdupedvars'),
    require('postcss-droproot'),
    require('postcss-focus-ring'),
    secondNotNested ? require('../tools/component-builder/css/plugins/postcss-notnested')() : null, // Second one to catch all stray &

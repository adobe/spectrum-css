...
/***/ "./data lazy recursive ^\\.\\/.*\\.yml$":
/*!**************************************************!*\
  !*** ./data lazy ^\.\/.*\.yml$ namespace object ***!
  \**************************************************/
...
webpackAsyncContext.id = "./data lazy recursive ^\\.\\/.*\\.yml$";
...
async function loadData(id) {
  let data = await __webpack_require__("./data lazy recursive ^\\.\\/.*\\.yml$")(`./${id}.yml`);
  console.log({
    data
  });
  return "poop";
...
Page.getInitialProps = async function (context) {
  ...
  const pageData = await __webpack_require__("./data lazy recursive ^\\.\\/.*\\.yml$")(`./${id}.yml`);
  return {

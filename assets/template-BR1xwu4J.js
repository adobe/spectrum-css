import{T as I}from"./template-aW6YKWXQ.js";import{n as t,a as h,g as B,o as T}from"./decorator-pHS56Kgw.js";import{x as $}from"./lit-element-Cr8ugfRm.js";import{o as m}from"./if-defined-C5sRMNk0.js";const J=({rootClass:e="spectrum-Thumbnail",size:i=500,imageURL:c,svg:p,altText:a,isCover:r=!1,isDisabled:v=!1,isFocused:y=!1,isLayer:n=!1,isSelected:l=!1,backgroundColor:d,onclick:s,customClasses:w=[],customStyles:j={},id:g=B("thumbnail")}={},q={})=>{const{updateArgs:b}=q,A=c?$`<img class="${e}-image" src=${c} alt=${m(a)} />`:p?$`${p}`:"",x=$`

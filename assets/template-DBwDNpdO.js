import{g as L,R as c,s as C,n as D,C as i}from"./decorator-BtqfPG1l.js";import{k as t}from"./lit-element-C96egxJg.js";import{t as m}from"./if-defined-B5hOZ0d5.js";import{c as V}from"./capitalize-D60SaZ2R.js";const g=(n={},e={})=>{var A;let{rootClass:d,semantics:r,size:l="m",variant:p,weight:S,glyph:v="sans-serif",id:h=L("typography"),content:u=[],customClasses:k=[],customStyles:b={},skipLineBreak:H=!1,lang:j=((A=e.globals)==null?void 0:A.lang)||"en-US"}=n;if(Array.isArray(u)||(u=[u]),u.length===0)return t``;const I=u.map(a=>{if(typeof a!="string"&&typeof a=="object"&&!a._$litType$)return g({...n,...a},e);switch(l){case"xxs":["body","code"].includes(r)?l="xs":["detail"].includes(r)&&(l="s");break;case"xs":["detail"].includes(r)&&(l="s");break;case"xxl":["detail","code"].includes(r)&&(l="xl");break;case"xxxl":["detail","code"].includes(r)&&(l="xl");break}if(typeof r>"u")return t`
	...
	`},e),K=(n,e)=>i({withBorder:!1,wrapperStyles:{"row-gap":"0"},content:i({direction:"column",heading:"Japanese",wrapperStyles:{"row-gap":"0"},content:g({...n,content:["暗号","Code"],semantics:"code",lang:"ja",skipLineBreak:!0},e)},e)},e),O=(n,e)=>i({direction:"column",withBorder:!1,content:g({...n,lang:"ja",content:[{semantics:"heading",content:"見出し",customStyles:{"margin-block-start":"0"}},{semantics:"body",content:"見出しとよく対になる本文。"}]},e)},e);export{E as D,g as T,U as a,P as b,G as c,M as d,F as e,N as f,O as g,_ as h,K as i};

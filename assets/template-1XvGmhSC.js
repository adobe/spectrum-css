import{T as B}from"./template-B2A9LdU4.js";import{T as F}from"./template-DTy_b55N.js";import{T as I}from"./template-VwUDRV6W.js";import{g as b,R as k,n as v,C as a}from"./decorator-BtqfPG1l.js";import{T as G}from"./template-DohBd9d3.js";import{k as $}from"./lit-element-C96egxJg.js";import{t as p}from"./if-defined-B5hOZ0d5.js";const o=({rootClass:e="spectrum-FieldGroup",customClasses:r=[],layout:f="vertical",inputType:l="radio",name:w=b(),isReadOnly:t=!1,isRequired:n=!1,label:u,labelPosition:s,isInvalid:c,helpText:h,items:g=[]}={},m={})=>{const T=b("group-label");return $`
		<div

import{O as l}from"./lit-element-C96egxJg.js";import{R as h,s as u}from"./decorator-BtqfPG1l.js";const n=({rootClass:e="spectrum-ColorLoupe",isOpen:r=!0,isDisabled:t=!1,customStyles:s={},customClasses:a=[],selectedColor:o="rgba(255, 0, 0, 0.5)"}={})=>l`
    <svg
      class=${h({[e]:!0,"is-open":r,"is-disabled":t,...a.reduce((p,c)=>({...p,[c]:!0}),{})})}
      style=${u({"--spectrum-picked-color":o,...s})}
    >
      <defs>
        <path
          id="loupe-path"

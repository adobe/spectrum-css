import{T as k}from"./template-5kpiFLJK.js";import{T as F}from"./template-Bo-K_S9A.js";import{T as I}from"./template-DydlwUvj.js";import{C as a,g as b,a as v,n as w}from"./decorator-pHS56Kgw.js";import{T as q}from"./template-BSkuK6Pi.js";import{x as s}from"./lit-element-Cr8ugfRm.js";import{o as m}from"./if-defined-C5sRMNk0.js";const o=({rootClass:e="spectrum-FieldGroup",customClasses:r=[],layout:$="vertical",inputType:p="radio",name:B=b(),isReadOnly:i=!1,isRequired:f=!1,label:l,labelPosition:u,isInvalid:c,helpText:h,items:g=[]}={},n={})=>{const T=b("group-label");return s`
		<div

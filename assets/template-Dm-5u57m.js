import{b as l}from"./lit-element-Cr8ugfRm.js";import{a as h,o as u}from"./decorator-DlLJAwnS.js";const n=({rootClass:e="spectrum-ColorLoupe",isOpen:r=!0,isDisabled:t=!1,customStyles:s={},customClasses:o=[],selectedColor:a="rgba(255, 0, 0, 0.5)"}={})=>l`
    <svg
      class=${h({[e]:!0,"is-open":r,"is-disabled":t,...o.reduce((p,c)=>({...p,[c]:!0}),{})})}
      style=${u({"--spectrum-picked-color":a,...s})}
    >
      <defs>
        <path
          id="loupe-path"

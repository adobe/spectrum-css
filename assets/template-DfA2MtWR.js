import{T as y}from"./template-yc65Btu_.js";import{C as a,n as m,a as c,o as v}from"./decorator-pHS56Kgw.js";import{x as n}from"./lit-element-Cr8ugfRm.js";import{c as f}from"./capitalize-A3_7q2MJ.js";const d=({rootClass:t="spectrum-Tooltip",label:e,variant:o="neutral",placement:s,isOpen:r=!0,isFocused:$=!1,showOnHover:h=!1,customStyles:g={},customClasses:b=[]}={},w={})=>{let p;return o==="info"?p="Info":o==="positive"?p="CheckmarkCircle":o==="negative"&&(p="Alert"),h&&document.addEventListener("DOMContentLoaded",()=>{[...document.querySelectorAll(`.${t}`)].forEach(l=>{var i;(i=l.parentElement)==null||i.classList.add("u-tooltip-showOnHover")})}),n`
		<span

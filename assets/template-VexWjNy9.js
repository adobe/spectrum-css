import{T as v}from"./template-yc65Btu_.js";import{C as m,a as F,o as N,n as p,g as P}from"./decorator-pHS56Kgw.js";import{T as R}from"./template-BhyvVUSF.js";import{x as a}from"./lit-element-Cr8ugfRm.js";import{o as l}from"./if-defined-C5sRMNk0.js";import{c as U}from"./capitalize-A3_7q2MJ.js";const n=({rootClass:e="spectrum-Button",id:t=P("button"),testId:o,customClasses:B=[],customStyles:x={},size:i="m",label:d,hideLabel:u=!1,iconName:r,iconSet:w="workflow",iconAfterLabel:h=!1,variant:b,staticColor:f,treatment:y,onclick:W,isDisabled:S=!1,isHovered:I=!1,isFocused:g=!1,isActive:k=!1,isPending:T=!1,ariaExpanded:$,ariaControls:G,noWrap:z=!1}={},c={})=>{const{updateArgs:s}=c;return a`
	<button

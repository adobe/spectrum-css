import{T as y}from"./template-CKQlC29v.js";import{R as m,s as v,n as c,C as a}from"./decorator-BliclrE4.js";import{k as s}from"./lit-element-C96egxJg.js";import{c as f}from"./capitalize-D60SaZ2R.js";const d=({rootClass:e="spectrum-Tooltip",label:t,variant:o="neutral",placement:n,isOpen:r=!0,isFocused:$=!1,showOnHover:h=!1,customStyles:g={},customClasses:b=[]}={},w={})=>{let p;return o==="info"?p="Info":o==="positive"?p="CheckmarkCircle":o==="negative"&&(p="Alert"),h&&document.addEventListener("DOMContentLoaded",()=>{[...document.querySelectorAll(`.${e}`)].forEach(l=>{var i;(i=l.parentElement)==null||i.classList.add("u-tooltip-showOnHover")})}),s`
		<span

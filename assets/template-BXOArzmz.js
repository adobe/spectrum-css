import{R as r,s as l,g as u}from"./decorator-BliclrE4.js";import{k as t,O as d}from"./lit-element-C96egxJg.js";import{t as f}from"./if-defined-B5hOZ0d5.js";const H=({rootClass:c="spectrum-Asset",image:s,preset:i,id:h=u("asset"),customClasses:n=[],customStyles:p={},isImageFill:a=!1}={})=>{let e;return i==="file"?e=d`
    <svg viewBox="0 0 128 128" class="${c}-file" width="10">
      ...
      <svg viewBox="0 0 32 32" class="${c}-folder" width="10">
        ...
        <path class="${c}-folderOutline" d="M29,6H18.3c-0.1,0-0.2,0-0.4-0.2l-3.1-3.1C14.4,2.3,13.8,2,13.1,2H3C1.3,2,0,3.3,0,5v22c0,1.6,1.3,3,3,3h26c1.7,0,3-1.4,3-3V9C32,7.3,30.7,6,29,6z M31,27c0,1.1-0.9,2-2,2H3c-1.1,0-2-0.9-2-2V7h28c1.1,0,2,0.9,2,2V27z"></path>
			...
			class="${c}-image"
			src=${f(s)}
			style=${l({"max-inline-size":a?void 0:"75%","max-block-size":a?void 0:"75%"})}
		/>`),t` <div
		class=${r({[c]:!0,...n.reduce((v,$)=>({...v,[$]:!0}),{})})}
		id=${f(h)}
		style=${l(p)}
	>
		${e}

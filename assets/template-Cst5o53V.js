import{T as A}from"./template-XOE-O1Gr.js";import{n as p,R as h,s as T,g as q}from"./decorator-BliclrE4.js";import{k as $}from"./lit-element-C96egxJg.js";import{t}from"./if-defined-B5hOZ0d5.js";const H=({rootClass:e="spectrum-Thumbnail",size:i=500,imageURL:c,svg:m,altText:a,isCover:r=!1,isDisabled:v=!1,isFocused:s=!1,isLayer:n=!1,isSelected:y=!1,backgroundColor:d,onclick:l,customClasses:w=[],customStyles:I={},id:g=q("thumbnail")}={},O={})=>{const{updateArgs:b}=O,k=c?$`<img class="${e}-image" src=${c} alt=${t(a)} />`:m?$`${m}`:"",j=$`

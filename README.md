...
| `refresh:config` | This takes the data from the root-level `.env` file and pulls out the Chromatic-specific values that need to live inside the Storybook package in order to be correctly picked up by Chromatic.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | `yarn refresh:config`                                                                    |
| `refresh`        | Runs `refresh:env` first to set up the root-level `.env` file and then kicks off `refresh:config`, to copy the relevant data down to Storybook.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | `yarn refresh`                                                                           |

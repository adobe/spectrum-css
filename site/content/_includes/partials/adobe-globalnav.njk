<link
    rel="stylesheet"
    type="text/css"
    href="//wwwimages2.adobe.com/etc/beagle/public/globalnav/adobe-globalnav/latest/adobe-globalnav.min.css"/>
<script>
window.adobeGlobalnavConfig = {
  ...
  callbacks: {
    globalnav_ready: function() {
      ...
      // Reveal the divider after the global nav has loaded
      document.querySelector('.spectrum-Site-footerContainer').removeAttribute('hidden');
    }
  }
}
</script>

...
export default function Search(el,
	{
		index = {},
		store = {},
		onFocusCallback,
...
<div class="spectrum-Site-search" role="search">
  ...
  <div class="spectrum-Popover spectrum-Popover--bottom spectrum-Site-searchResults js-popover">
...
`;
	...
	if (results.length) {
  	...
  	<li class="spectrum-Menu-item" role="presentation" aria-labelledby="searchResults-${category}">
		...
		<ul class="spectrum-Menu spectrum-Menu--sizeM" role="group">
			...
			<li class="spectrum-Menu-item" role="option">
				<a class="spectrum-Menu-itemLabel" href="${result.href}">${result.name}</a>
			</li>`).join("\n")}
		</ul>
	</li>` : "").join("\n");

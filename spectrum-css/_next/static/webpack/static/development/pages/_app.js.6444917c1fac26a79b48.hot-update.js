...
function (_App) {
  ...
  function MyApp(props) {
    ...
    next_router__WEBPACK_IMPORTED_MODULE_13__["Router"].events.on('routeChangeComplete', function () {
      console.log(_arguments[0].pageProps.pageData.name); // digitalData._set('page.pageInfo.pageName', `spectrum.adobe.com:${this.props.pageData.page.fields.category || 'unknown'}:${this.props.pageData.slug}`);
...
//# sourceMappingURL=_app.js.6444917c1fac26a79b48.hot-update.js.map
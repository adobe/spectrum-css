...
function (_App) {
  ...
  function MyApp(props) {
    ...
    next_router__WEBPACK_IMPORTED_MODULE_13__["Router"].events.on('routeChangeComplete', function (data, data2) {
      console.log(data); // digitalData._set('page.pageInfo.pageName', `spectrum.adobe.com:${this.props.pageData.page.fields.category || 'unknown'}:${this.props.pageData.slug}`);
...
//# sourceMappingURL=_app.js.4d1767d2d34d4ab3290e.hot-update.js.map
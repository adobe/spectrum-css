...
function (_App) {
  ...
  function MyApp(props) {
    ...
    next_router__WEBPACK_IMPORTED_MODULE_13__["Router"].events.on('routeChangeComplete', function (data) {
      console.log(data.pageProps.pageData.name); // digitalData._set('page.pageInfo.pageName', `spectrum.adobe.com:${this.props.pageData.page.fields.category || 'unknown'}:${this.props.pageData.slug}`);
...
//# sourceMappingURL=_app.js.688da43c96b0c6ee0cee.hot-update.js.map
...
function (_App) {
  ...
  function MyApp(props) {
    ...
    next_router__WEBPACK_IMPORTED_MODULE_13__["Router"].events.on('routeChangeComplete', function () {
      console.log(_arguments[0].router);

      digitalData._set('page.pageInfo.pageName', _arguments[0].pageProps.pageData.name); // digitalData._set('page.pageInfo.siteSection', `${this.props.pageData.slug} Page`);
...
//# sourceMappingURL=_app.js.b13f19fcc3628613a67f.hot-update.js.map
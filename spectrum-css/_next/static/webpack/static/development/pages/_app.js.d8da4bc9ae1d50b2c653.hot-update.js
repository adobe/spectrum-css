  ...
  function MyApp(props) {
    ...
    next_router__WEBPACK_IMPORTED_MODULE_13__["Router"].events.on('routeChangeComplete', function (data, data2) {
      console.log({
        data: data,
        data2: data2
      }); // digitalData._set('page.pageInfo.pageName', `spectrum.adobe.com:${this.props.pageData.page.fields.category || 'unknown'}:${this.props.pageData.slug}`);
...
//# sourceMappingURL=_app.js.d8da4bc9ae1d50b2c653.hot-update.js.map
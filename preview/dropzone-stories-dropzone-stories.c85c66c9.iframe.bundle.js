...
`;var link_stories_template=__webpack_require__("../components/link/stories/template.js");const dropzone_stories={title:"Drop zone",component:"DropZone",argTypes:{isDragged:{name:"Dragged",type:{name:"boolean"},table:{type:{summary:"boolean"},category:"State"},control:"boolean"},isFilled:{name:"Filled",type:{name:"boolean"},table:{type:{summary:"boolean"},category:"State"},control:"boolean",if:{arg:"isDragged",truthy:!0}}},args:{rootClass:"spectrum-DropZone",isDragged:!1,isFilled:!1},parameters:{actions:{handles:[]},docs:{description:{component:'A drop zone is an area on the screen into a which an object can be dragged and dropped to accomplish a task. For example, a drop zone might be used in an upload workflow to enable the user to simply drop a file from their operating system into the drop zone, which is a more efficient and intuitive action, rather than utilize the standard "Choose file" dialog.'}}}},Default=args=>lit.qy`
    <div>
        ${Template({...args})}
...
//# sourceMappingURL=dropzone-stories-dropzone-stories.c85c66c9.iframe.bundle.js.map
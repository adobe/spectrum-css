import{T as B}from"./template-BRMtA7j6.js";import{T as D}from"./template-mlz8kN-l.js";import{T as O}from"./template-BBAyYaQJ.js";import{T as S}from"./template-DJxH4dO_.js";import{R as q,a as o,s as p,n,r as v,g as w}from"./template-CykOH8vE.js";import{k as a}from"./lit-element-C96egxJg.js";const I=({rootClass:e="spectrum-Dialog",isDismissible:l=!1,hasDivider:s=!0,isOpen:$=!0,showModal:g=!1,hasFooter:T=!1,heading:c,content:y=[],footer:r=[],customClasses:k=[],id:b=w("dialog"),size:m="medium",layout:t,heroImageUrl:f,customStyles:h={}}={},i={})=>{const{updateArgs:A}=i,R=()=>A({isOpen:!$}),u=a`
		<div

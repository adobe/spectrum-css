import{T as H}from"./template-C9PkAyt7.js";import{T as Q}from"./template-CotMDNmo.js";import{T as U}from"./template-BBAyYaQJ.js";import{T as A}from"./template-CjNf7Zto.js";import{T as O}from"./template-CFzFm5hn.js";import{R as c,a as b,s as P,g as I,C as T,n as o}from"./template-CykOH8vE.js";import{T as C}from"./template-BI8UA81D.js";import{T as F}from"./template-D5W5kXKr.js";import{k as l}from"./lit-element-C96egxJg.js";const L=(e="m",t="ArrowLeft")=>{switch(e){case"s":return`${t}200`;case"l":return`${t}400`;case"xl":return`${t}500`;default:return`${t}300`}},V=({rootClass:e="spectrum-Menu-item",label:t,description:i,iconName:a,iconSet:h="workflow",hasActions:$=!1,id:w=I("menuitem"),idx:S=0,isActive:f=!1,isCollapsible:u=!1,isDisabled:r=!1,isDrillIn:M=!1,isFocused:d=!1,isHighlighted:k=!1,isHovered:x=!1,isOpen:m=!1,isSelected:p=!1,items:v=[],role:y="menuitem",shouldTruncate:n=!1,size:s="m",selectionMode:D="none",value:E,customClasses:G=[],customStyles:R={}}={},N={})=>l`
	<li

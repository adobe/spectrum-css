import{k as a}from"./lit-element-C96egxJg.js";import{R as k,a as y}from"./template-C7mrcesf.js";import{T as f}from"./template-C8oSNaTT.js";import"./v4-CQkTLCs1.js";import"./capitalize-D60SaZ2R.js";import"./template-CNHi6PLw.js";const h="@spectrum-css/quickaction",x="3.1.1",v="The Spectrum CSS quickaction component",$="Apache-2.0",q="Adobe",z="https://opensource.adobe.com/spectrum-css/quickaction",C={type:"git",url:"https://github.com/adobe/spectrum-css.git",directory:"components/quickaction"},O={url:"https://github.com/adobe/spectrum-css/issues"},A="dist/index-vars.css",Q={"@spectrum-css/actionbutton":">=5","@spectrum-css/checkbox":">=8","@spectrum-css/vars":">=9"},w={"@spectrum-css/commons":"^9.1.1"},D={access:"public"},S="21308ac4b92a5637eebea3e2a6611aab34a7a7b8",N={name:h,version:x,description:v,license:$,author:q,homepage:z,repository:C,bugs:O,main:A,peerDependencies:Q,devDependencies:w,publishConfig:D,gitHead:S},R={title:"Quick actions",component:"QuickAction",argTypes:{content:{table:{disable:!0}},isOpen:{name:"Open",type:{name:"boolean"},table:{type:{summary:"boolean"},category:"Component"},control:"boolean"},position:{name:"Position",type:{name:"string"},table:{type:{summary:"string"},category:"Component"},control:"select",options:["left","right"]},textOnly:{name:"Text only action buttons",type:{name:"boolean"},table:{type:{summary:"boolean"},category:"Advanced"},control:"boolean"}},args:{rootClass:"spectrum-QuickActions",isOpen:!0,textOnly:!1,content:[{iconName:"Edit",iconSet:"workflow",label:"Edit"},{iconName:"Copy",iconSet:"workflow",label:"Copy"},{iconName:"Delete",iconSet:"workflow",label:"Delete"}]},parameters:{chromatic:{disableSnapshot:!0},status:{type:"deprecated"},packageJson:{...N,spectrum:[{guidelines:"https://spectrum.adobe.com/page/quick-actions/",rootClass:"spectrum-QuickActions"}]},docs:{description:{component:"**This component is deprecated.** Please use an action bar to allow users to perform actions on either a single or multiple items at the same time, instead."}}}},T=({rootClass:t="spectrum-QuickActions",size:n="m",isOpen:l=!1,textOnly:r=!1,position:i,content:o=[],id:m,customClasses:d=[]}={},b={})=>o.length?(o.some(e=>e.icon)||(r=!0),a`
        ...
        <div
            class="${k({[t]:!0,[`${t}--size${n==null?void 0:n.toUpperCase()}`]:typeof n<"u","is-open":l,[`${t}--${i}`]:typeof i<"u",[`${t}--textOnly`]:r,...d.reduce((e,g)=>({...e,[g]:!0}),{})})}"
            id=${y(m)}
        >
            ${o.map(e=>typeof e=="object"&&e.iconName||e.label?f({...e,isQuiet:!0},b):e)}
        </div>
    `):(console.warn("QuickActions: requires content be passed in to render."),a``),s=T.bind({});s.args={};var c,p,u;s.parameters={...s.parameters,docs:{...(c=s.parameters)==null?void 0:c.docs,source:{originalSource:`({
  ...
  return html\`
    ...
    \`;
}`,...(u=(p=s.parameters)==null?void 0:p.docs)==null?void 0:u.source}}};const U=["Default"];export{s as Default,U as __namedExportsOrder,R as default};

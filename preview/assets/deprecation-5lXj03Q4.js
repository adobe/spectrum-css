import{j as e}from"./jsx-runtime-_09DdfSq.js";import{u as i}from"./index-CXGxovgH.js";import{ae as a}from"./index-BreQY16V.js";import"./iframe-MtCp54vn.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-BosuxZz1.js";import"./index-DxKRhftL.js";import"./index-DrFu-skq.js";function o(n){const t={a:"a",code:"code",em:"em",h1:"h1",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...i(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(a,{title:"Deprecation workflow"}),`
...
b. Update any local references to point to the package name instead, i.e.,`,e.jsx("br",{}),e.jsx(t.em,{children:"Original"}),":",e.jsx("br",{}),e.jsx(t.code,{children:'import { Template } from "./template";'}),e.jsx("br",{}),e.jsx("br",{}),e.jsx(t.em,{children:"Updated to"}),":",e.jsx("br",{}),e.jsx(t.code,{children:'import { Template } from "@spectrum-css/quickaction/stories/template.js";'}),`.
...
`})}),`
`]}),`
`,e.jsxs(t.li,{children:["Update the status of the component to ",e.jsx(t.code,{children:"Deprecated"})," in the ",e.jsx(t.code,{children:"*.yml"})," file. Add any additional migration notes to the ",e.jsx(t.code,{children:"deprecationNotice"})," keyword. i.e.,",`
`,e.jsx(t.pre,{children:e.jsx(t.code,{className:"language-yaml",children:`name: Quick actions
status: Deprecated
...
`,e.jsxs(t.li,{children:["Copy ",e.jsx(t.code,{children:"*.stories.js"})," and ",e.jsx(t.code,{children:"metadata/*.yml"})," into the new folder (directly, not nested inside subfolders)."]}),`

import{T as A}from"./template-Deiy8Oth.js";import{n as m,R as h,a as t,s as T,g as q}from"./template-C7mrcesf.js";import{k as $}from"./lit-element-C96egxJg.js";const G=({rootClass:e="spectrum-Thumbnail",size:c=500,imageURL:i,svg:p,altText:a,isCover:r=!1,isDisabled:v=!1,isFocused:s=!1,isLayer:n=!1,isSelected:y=!1,backgroundColor:d,onclick:l,customClasses:w=[],customStyles:I={},id:g=q("thumbnail")}={},O={})=>{const{updateArgs:b}=O,k=i?$`<img class="${e}-image" src=${i} alt=${t(a)} />`:p?$`${p}`:"",j=$`

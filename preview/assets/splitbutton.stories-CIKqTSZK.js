import{k as z}from"./lit-element-C96egxJg.js";import{R as y}from"./template-CykOH8vE.js";import{T as c}from"./template-DSrU9Zmp.js";import"./v4-CQkTLCs1.js";import"./capitalize-D60SaZ2R.js";import"./template-CjNf7Zto.js";import"./template-CjHMi-cO.js";const v="@spectrum-css/splitbutton",S="8.1.2",B="The Spectrum CSS splitbutton component",C="Apache-2.0",N="Adobe",D="https://opensource.adobe.com/spectrum-css/splitbutton",L={type:"git",url:"https://github.com/adobe/spectrum-css.git",directory:"components/splitbutton"},$={url:"https://github.com/adobe/spectrum-css/issues"},k="dist/index-vars.css",w={"@spectrum-css/button":">=11","@spectrum-css/icon":">=4","@spectrum-css/vars":">=9"},T={"@spectrum-css/icon":{optional:!0}},A={access:"public"},M="662aadb29fbb761e46a6d0fb75eb1c7663da958d",O={name:v,version:S,description:B,license:C,author:N,homepage:D,repository:L,bugs:$,main:k,peerDependencies:w,peerDependenciesMeta:T,publishConfig:A,gitHead:M},E={title:"Split button",component:"SplitButton",argTypes:{size:{name:"Size",type:{name:"string",required:!0},table:{disable:!0},options:["m"],control:"select"},variant:{name:"Variant",type:{name:"string"},table:{disable:!0},options:["accent","primary","secondary"],control:"select"},position:{name:"Position",type:{name:"string",required:!0},table:{type:{summary:"string"},category:"Component"},options:["right","left"],control:"select"},iconName:{table:{disable:!0}},label:{name:"Label",type:{name:"string"},table:{type:{summary:"string"},category:"Content"},control:{type:"text"}}},args:{rootClass:"spectrum-SplitButton",size:"m",position:"right",label:"Split Button",variant:"accent",iconName:"ChevronDown100"},parameters:{chromatic:{disableSnapshot:!0},status:{type:"deprecated"},packageJson:O,docs:{description:{component:`**This component is deprecated.** Please use a button group to show any additional actions related to the most critical action. Reference [Spectrum documentation](https://spectrum.corp.adobe.com/page/button-group/#Use-a-button-group-to-show-additional-actions) for more information.
...
A split button surfaces an immediately invokable action via it's main button, as well as a list of alternative actions in its toggle-able menu overlay.`}}}},R=({rootClass:s="spectrum-SplitButton",customClasses:b=[],customFirstButtonClasses:g=[],customLastButtonClasses:f=[],size:i="m",variant:o="cta",iconName:r="ChevronDown100",iconSet:a="ui",labelIconName:n=void 0,position:e="right",label:p="Split button"}={},l={})=>z`
  ...
  return html\`
    ...
    \`;
}`,...(d=(m=t.parameters)==null?void 0:m.docs)==null?void 0:d.source}}};const U=["Default"];export{t as Default,U as __namedExportsOrder,E as default};

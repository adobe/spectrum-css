import{T as y}from"./template-CjNf7Zto.js";import{R as c,s as v,n as m,C as a}from"./template-CykOH8vE.js";import{k as o}from"./lit-element-C96egxJg.js";import{c as f}from"./capitalize-D60SaZ2R.js";const d=({rootClass:t="spectrum-Tooltip",label:n,variant:e="neutral",placement:s,isOpen:r=!0,isFocused:$=!1,showOnHover:h=!1,customStyles:g={},customClasses:b=[]}={},w={})=>{let p;return e==="info"?p="Info":e==="positive"?p="CheckmarkCircle":e==="negative"&&(p="Alert"),h&&document.addEventListener("DOMContentLoaded",()=>{[...document.querySelectorAll(`.${t}`)].forEach(l=>{var i;(i=l.parentElement)==null||i.classList.add("u-tooltip-showOnHover")})}),o`
		<span

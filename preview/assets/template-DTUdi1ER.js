import"./lit-element-CJjJlyWZ.js";import{b as a}from"./lit-html-BdGv-Ldy.js";import{a as c}from"./class-map-sTkR_Npl.js";import{o as i}from"./style-map-yx2CMG_J.js";const d=({rootClass:e="spectrum-ColorLoupe",isOpen:r,customStyles:t={"--spectrum-picked-color":"rgba(255, 0, 0, 0.5)","inset-block-start":"5px","inset-inline-start":"5px"},customClasses:o=[]})=>a`
    <svg
      class=${c({[e]:!0,"is-open":r,...o.reduce((s,p)=>({...s,[p]:!0}),{})})}
      style=${i(t)}
    >
      <defs>
        <path
